import { 拼接字节数据, 数据转Uint8Array } from '../core/bytes.js';
import { log } from '../core/context.js';
import { 创建请求TCP连接器 } from './dial.js';
import { WebSocket发送并等待 } from './grain.js';
import { 转发木马UDP反代数据 } from './trojan-relay.js';
...
export { forwardataudp, 转发木马UDP数据 };
