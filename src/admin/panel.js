...
#status{margin-left:10px;font-size:13px;color:#8b93a7;word-break:break-all}
.iprow dt{font-size:12px;color:#8b93a7;margin:0 0 6px}.iprow{display:flex;gap:10px;align-items:flex-start;flex-wrap:wrap}
table.probe{width:100%;border-collapse:collapse;font-size:13px;margin-top:10px}table.probe td{padding:5px 8px;border-bottom:1px solid #232c3e;overflow-wrap:anywhere}table.probe td.ok{color:#6fd18a}table.probe td.bad{color:#f2706c}</style></head><body><div class="wrap">
